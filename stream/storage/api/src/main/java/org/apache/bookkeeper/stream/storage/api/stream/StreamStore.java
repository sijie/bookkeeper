...
/**
 * The stream store that stores and serves streams.
 */
public interface StreamStore {

    CompletableFuture<StreamRangeWriter> openStreamRangeWriter(SetupWriterRequest request);

    CompletableFuture<StreamRangeReader> openStreamRangeReader(SetupReaderRequest request);
