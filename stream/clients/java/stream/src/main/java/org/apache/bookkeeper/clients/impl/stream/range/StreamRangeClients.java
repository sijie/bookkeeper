...
public class StreamRangeClients {
    ...
    interface StreamRangeEventSetWriterFactory {
        StreamRangeEventSetWriter newEventSetWriter(
            RangeId rid,
            String writerName,
    ...
    interface StreamRangeEventSetReaderFactory {
        StreamRangeEventSetReader newEventSetReader(
            RangeId rid,
    ...
    private final StreamRangeEventSetWriterFactory writerFactory;
    private final StreamRangeEventSetReaderFactory readerFactory;
    ...
    public StreamRangeClients(StorageContainerChannelManager scChannelManager,
        ...
        this(
            scChannelManager,
            scheduler,
            (rid, writerName, executor, channel) ->
                new StreamRangeEventSetWriterImpl(rid, writerName, executor, channel),
            (rid, writerName, executor, channel, maxReadAheadBytes, reconnectBackoffMs) ->
                new StreamRangeEventSetReaderImpl(
                    rid, writerName, executor, channel, maxReadAheadBytes, reconnectBackoffMs)
        );
    }

    @VisibleForTesting
    StreamRangeClients(StorageContainerChannelManager scChannelManager,
                       OrderedScheduler scheduler,
                       StreamRangeEventSetWriterFactory writerFactory,
                       StreamRangeEventSetReaderFactory readerFactory) {
    ...
    public CompletableFuture<StreamRangeEventSetWriter> openStreamRangeWriter(long streamId,
        ...
        StreamRangeEventSetWriter writer = writerFactory.newEventSetWriter(
    ...
    public CompletableFuture<StreamRangeEventSetReader> openStreamRangeReader(long streamId,
        ...
        StreamRangeEventSetReader reader = readerFactory.newEventSetReader(
            rid,
            pos,
